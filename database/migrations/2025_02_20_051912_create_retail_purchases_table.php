...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('retail_purchases', function (Blueprint $table) {
            ...
            $table->enum('payment_method', PaymentMethod::keys())->default(PaymentMethod::CARD)->comment('결제 수단(cash, card, mobile, other)');
            $table->enum('status', RetailPurchaseStatus::keys())->default(RetailPurchaseStatus::PENDING)->comment('판매상태(completed, pending, canceled, refunded)');
