...
class OrderShipmentFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'status' => fake()->randomElement(OrderShipmentStatus::names()),
            ...
            'deliveryType' => fake()->randomElement(OrderShipmentDeliveryType::names()),
            ...
            'orderCellPhone' => fake()->cellPhoneNumber(),
            'receiverName' => fake()->name(),
            'receiverPhone' => fake()->phoneNumber(),
            'receiverCellPhone' => fake()->cellPhoneNumber(),
